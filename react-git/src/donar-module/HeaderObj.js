    ...
    return (
        <div className="flex flex-row flex-wrap justify-between border border-indigo-600 h-24">
            ...
            <div className="flex flex-row justify-end gap-3 border border-purple-500 w-1/2">
                <button className="relative w-12 h-12 mt-3 border border-slate-500 rounded-xl flex justify-center items-center bg-gray-700">
                     <Bell className="w-5 h-5 text-slate-200"/>
                </button>
                <button className="w-2/8 h-3/4 border border-slate-500 rounded-xl flex flex-row justify-center items-center gap-3 bg-gray-700 p-2">
